...
class StatusUpdateTool(object):
    ...
    @classmethod
    def get_layer_limit(cls):
        rs = cls.__read_ini_file('network','layer_num_limit')
        layer_limit = []
        for i in rs.split(','):
            layer_limit.append(int(i))
        return layer_limit[0], layer_limit[1]
    ...
    def get_init_params(cls):
        ...
        params['min_layer'], params['max_layer'] = cls.get_layer_limit()
